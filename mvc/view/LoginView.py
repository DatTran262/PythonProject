...
class Window(QWidget):
    ...
    def createLoginComponents(self):
        ...
        self.labelNotice.setGeometry(QRect(115, 270, 200, 45))
    ...
    def createSocialButton(self, x, y, iconPath, url):
        ...
        self.btn.clicked.connect(lambda: self.lc.openSocialApp(url))
    ...
    def newUser(self, x, y, txtFirst, txtSecond):
        ...
        self.btnTRansfer.setObjectName(
            "btnForgotPassword" if txtSecond == "Click Here" else "btnTransferSignUp"
        )
        ...
        self.btnTRansfer.clicked.connect(lambda: self.lc.clickSubBtnLogin(self.sender())) 
